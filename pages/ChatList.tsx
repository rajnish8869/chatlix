...
const ChatItemWrapper: React.FC<ChatItemWrapperProps> = ({ children, chatId, onLongPress, onClick }) => {
                ...
                return (
                    <div className="px-4 py-1">
                        ...
                        >
                            <div 
                                className={`
                                    relative p-4 rounded-[28px] transition-all cursor-pointer flex items-center gap-4 group
                                    ${isSelected 
